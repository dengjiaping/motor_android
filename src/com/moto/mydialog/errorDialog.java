...
public class errorDialog extends Dialog {
	...
	public static class Builder {
		...
		public errorDialog create() {
			...
			final errorDialog dialog = new errorDialog(context,R.style.Dialog);
			final View layout = inflater.inflate(R.layout.errordialog, null);
			...
			if (positiveButtonText != null) {
				((TextView) layout.findViewById(R.id.positive_button))
			...
			((TextView) layout.findViewById(R.id.error_detail)).setText(message);
