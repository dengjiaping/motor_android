...
public class CustomListView extends ListView implements OnScrollListener{
    ...
    private static LinearLayout mHeadRootView;
    private static TextView mTipsTextView;
    private static TextView mLastUpdatedTextView;
    private static ImageView mArrowImageView;
    ...
    /**  headView动画   */
    private static RotateAnimation mArrowAnim;
    /**  headView反转动画   */
    private static RotateAnimation mArrowReverseAnim;
    ...
    private Runnable mLoadCheckRunnable = new Runnable() {
        ...
        public void run() {
            if(mLastComparedDiffMillis < mUpdateIntervalMillis){
                CustomListView.this.postDelayed(mCheckRefRunnable,
...
//                checkRefresh();
            ...
            if(!mIsReadyToRefresh){
                CustomListView.this.post(mLoadCheckRunnable);
            }
        }
    };
...
//            checkRefresh();
    ...
    private void addHeadView() {
        mHeadRootView = (LinearLayout) mInflater.inflate(R.layout.refresh_header1, null);
        ...
        mHeadRootView.setPadding(0, 30, 0, 0);
//		checkRefresh();
...
//		System.out.println("getLastUpdatedText = "+_Text);
    ...
    private void addFooterView() {
        mEndRootView = mInflater.inflate(R.layout.refresh_footer1, null);
        ...
        if (mCanLoadMore) {
            ...
            switch (mEndState) {
                ...
                case ENDINT_AUTO_LOAD_DONE:// 自动刷新完成
                    ...
                    // 更    多
                    mEndLoadTipsTextView.setText("更多");
                    mEndLoadTipsTextView.setVisibility(View.VISIBLE);
                    mEndLoadProgressBar.setVisibility(View.GONE);
...
//					MyLogger.showLogWithLineNum(5, "mFirstItemIndex = "+mFirstItemIndex+"__!mIsRecored = "+!mIsRecored);
     ...
     * @version 1.0
     */
    public static void changeHeadViewByState() {
        switch (mHeadState) {
...
//                MyLogger.showLogWithLineNum(3, "changeHeaderViewByState ===>  DONE");
     ...
     * @version 1.0
     */
    private static void changeHeaderViewRefreshState(){
        mHeadRootView.setPadding(0, 115, 0, 0);
    ...
    public void onRefreshComplete() {
        ...
        mHeadState = DONE;
        // XXX前更新
        mLastUpdatedTextView.setText("上次刷新:" + new Date().toLocaleString());
        changeHeadViewByState();
